    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{trans('eng.tag')}}</li>
            </ol>
        </section>
                        ...
                        @else
                            <div class="col-md-12" id="listing">
                                ...
                                <div class="box box-default">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">{{trans('eng.tag')}}</h3>
                                        <?php

                                        $permission = helperPermissionLink(url('/configurations/tag'), url('/configurations/tag'));
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-hover table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">{{trans('eng.tagName')}}</th>
                                                @if($allowEdit||$allowDelete)
                                                    <th class="text-right">{{trans('eng.action')}}</th>@endif
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php $i = 1;?>
                                            @forelse($tags as $tag)
                                                <tr>
                                                    ...
                                                    <td class="text-right" width="10px;">
                                                        ...
                                                        @if($allowDelete)
                                                            {!! Form::open(['method' => 'DELETE', 'route'=>['tag.destroy',
                                                                $tag->id],'class'=> 'inline']) !!}
                                                            <button type="submit"
                            ...
                            <div class="col-md-3">
                                @if(\Request::segment(4)=='edit')
                                    @if($allowEdit)
                                        @include('configurations.tags.edit')
                                    @endif
                                @else
                                    @if($allowAdd)
                                        @include('configurations.tags.add')
                                    @endif
                                @endif
