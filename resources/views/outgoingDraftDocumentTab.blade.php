<div class="tab-pane" id="tab_3">
    <div class="table-responsive">
        <table id="incoming_dashboard" class="table table-bordered table-striped">
            <thead>
            <tr>
                <th style="width: 10px">S.N</th>
                <th style="width: 300px">Subject</th>
                <th>Institution</th>
                <th class="text-center"> Created / Signed</th>
            ...
            <tbody>
            @if(count($totalDraftDocument)>0)
                @foreach($totalDraftDocument as $key=>$outgoingDocument)
                    <tr>
