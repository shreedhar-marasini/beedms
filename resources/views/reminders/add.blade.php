    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{trans('eng.create')}} {{trans('eng.reminder')}}</h3>
                <?php
            ...
            <div class="box-body">
                {!! Form::open(['method'=>'post','url'=>'reminder']) !!}
                <div class="row">
                        <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                            ...
                            {!!Form::text('reminder_date',null,array('class'=>'form-control form_datetime','id'=>'datetimepicker','readonly'))!!}
                            ...
                            <div class="form-group {{ ($errors->has('reminder_to_email'))?'has-error':''}}">
                                <label>{{trans('eng.email')}}</label>
                                {!! Form::email('reminder_to_email',Auth::user()->email,['class'=>'form-control','placeholder' => ''.trans('eng.email').'']) !!}
