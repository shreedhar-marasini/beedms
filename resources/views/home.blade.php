...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <!-- Info boxes -->
            <div class="row">
                <div class="col-md-4 float-left col-lg-2 col-sm-4 col-xs-12">
                                ...
                                <div class="box">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="box-tools pull-right">
                                            ...
                                            <a href="{{url('user-widget/status',$userWidget->widget_id)}}"
                                    ...
                                    <div class="box-body">
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a href="#tab_1" data-toggle="tab">Incoming
                                                        Documents</a>
                                                </li>
                                                <li><a href="#tab_2" data-toggle="tab">Issued Documents</a></li>
                                                <li><a href="#tab_3" data-toggle="tab">Outgoing Document (Draft)</a>
                                                </li>
